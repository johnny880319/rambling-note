...
def _(mo):
    ...
    為了讓大部分玩家看懂， $10$ 以上的數字，在高度限制的地方允許輸入英文、希臘字母或十進位數字，產出的 siteswap 則會用字母顯示： $10$ 到 $35$ 是英文的 $a$ 到 $z$ ， $36$ 到 $59$ 接著用希臘字母的 $\alpha$ 到 $\omega$ 。此模擬的高度上限因此設定在 $59$ 。不過雜耍圈其實對於 $36$ 以上的數字應該沒有共識，這裡為了致敬玩家 [shun__z](https://www.instagram.com/shun__z/) 做出超過 $z$ 的高度時用 $\beta$ 表示 $37$，這裡就跟著沿用。
